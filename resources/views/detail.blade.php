      ...
      <div class="container-lg mt-5 mr-0">
        ...
        <div class="mt-3 w-100">
          ...
          <div class="intro align-top">
            ...
            <li class="list-group-item">平均予算:{{ $restaurant["budget"] }}</li>
            <li class="list-group-item">住所:{{ $restaurant["address"] }}</li>
            <li class="list-group-item">電話番号:{{ $restaurant["tel"] }}</li>
            <li class="list-group-item">ページURL:<a href="{{url( $restaurant['url'])}}" target="_blank" rel="noopener noreferrer">{{ $restaurant["url"] }}</a></li>
            </ul>
          </div>
        </div>
        @endforeach
